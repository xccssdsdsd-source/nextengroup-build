    ...
    <main className="overflow-x-hidden">
      ...
      <section className="px-6 py-16 bg-[#11161F] sm:px-8 lg:py-24">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#EAF0F7] mb-6">Co zawiera audyt SEO</h2>
          <div className="grid gap-6 mb-8 md:grid-cols-2">
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">Analiza on-page</h3>
              <p className="text-sm text-[#A6B2C4]">Sprawdzenie nagłówków, meta tagów, słów kluczowych, struktury treści i linkowania wewnętrznego.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">SEO techniczne</h3>
              <p className="text-sm text-[#A6B2C4]">Szybkość ładowania, wersja mobilna, Core Web Vitals, indeksowanie, mapa strony, robots.txt i znaczniki kanoniczne.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">Analiza linków</h3>
              <p className="text-sm text-[#A6B2C4]">Ocena jakości i liczby linków prowadzących do strony, porównanie z konkurencją i wskazanie szans na rozwój profilu linkowego.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">Analiza konkurencji</h3>
              <p className="text-sm text-[#A6B2C4]">Badanie najważniejszych konkurentów, ich strategii SEO i słów kluczowych, na które są widoczni.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">Analiza słów kluczowych</h3>
              <p className="text-sm text-[#A6B2C4]">Ocena obecnych fraz, ich potencjału ruchu, trudności oraz nowych tematów do zagospodarowania.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg bg-[#161C28]">
              <h3 className="font-bold text-[#EAF0F7] mb-2">Raport i rekomendacje</h3>
              <p className="text-sm text-[#A6B2C4]">Szczegółowy raport PDF z priorytetami działań i rekomendowaną kolejnością wdrożeń.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 bg-[#0A0E14] sm:px-8 lg:py-24">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#EAF0F7] mb-6">Jak zamówić audyt SEO</h2>
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-[#EAF0F7] mb-1">Skontaktuj się z nami</h3>
                <p className="text-sm text-[#A6B2C4]">Napisz do nas i podaj adres swojej strony oraz krótki opis biznesu.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#22D3EE] text-[#06141A] rounded-lg flex items-center justify-center font-bold">2</div>
              <div>
                <h3 className="font-bold text-[#EAF0F7] mb-1">Krótka rozmowa</h3>
                <p className="text-sm text-[#A6B2C4]">Ustalimy zakres audytu, priorytety i realny harmonogram pracy.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#22D3EE] text-[#06141A] rounded-lg flex items-center justify-center font-bold">3</div>
              <div>
                <h3 className="font-bold text-[#EAF0F7] mb-1">Przeprowadzenie audytu</h3>
                <p className="text-sm text-[#A6B2C4]">Sprawdzamy stronę od strony technicznej, treściowej i strategicznej.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#22D3EE] text-[#06141A] rounded-lg flex items-center justify-center font-bold">4</div>
              <div>
                <h3 className="font-bold text-[#EAF0F7] mb-1">Raport i omówienie</h3>
                <p className="text-sm text-[#A6B2C4]">Przekazujemy raport i omawiamy wnioski oraz rekomendowane działania.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#22D3EE] text-[#06141A] rounded-lg flex items-center justify-center font-bold">5</div>
              <div>
                <h3 className="font-bold text-[#EAF0F7] mb-1">Wdrożenie opcjonalne</h3>
                <p className="text-sm text-[#A6B2C4]">Jeśli chcesz, możemy też wdrożyć rekomendacje wynikające z audytu.</p>
              </div>
            </div>
          </div>
        </div>
