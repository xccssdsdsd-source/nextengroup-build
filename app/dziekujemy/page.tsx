    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative bg-[#0A0E14] pt-20 pb-16 sm:pt-28 sm:pb-24 min-h-[70vh] flex items-center">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 sm:px-8 text-center">
          <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-full border border-[rgba(76, 130, 234,0.3)] bg-[rgba(76, 130, 234,0.08)]">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#4C82EA" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M20 6 9 17l-5-5" />
            </svg>
          </div>

          <span className="text-[11px] font-semibold uppercase tracking-widest text-[#4C82EA] mb-3 block">Wiadomość wysłana</span>
          ...
          <p className="text-[15px] sm:text-[16px] leading-[1.7] text-[#A6B2C4]">
            Odezwiemy się w ciągu <span className="text-[#4C82EA] font-semibold">24 godzin</span> w dni robocze.
          </p>
