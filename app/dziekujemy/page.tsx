    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative bg-[var(--bg-base)] pt-20 pb-16 sm:pt-28 sm:pb-24 min-h-[70vh] flex items-center">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 sm:px-8 text-center">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-widest text-[var(--brand)] mb-3 block">Wiadomość wysłana</span>
          <h1 className="text-[36px] sm:text-[48px] font-extrabold leading-[1.15] tracking-[-0.03em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
            Dziękujemy!
          </h1>
          <p className="text-[15px] sm:text-[16px] leading-[1.7] text-[var(--ink-2)] mb-2">
            Otrzymaliśmy Twoje zapytanie. Wysłaliśmy też potwierdzenie na Twój adres e-mail.
          </p>
          <p className="text-[15px] sm:text-[16px] leading-[1.7] text-[var(--ink-2)]">
            Odezwiemy się w ciągu <span className="text-[var(--brand)] font-semibold">24 godzin</span> w dni robocze.
          </p>
