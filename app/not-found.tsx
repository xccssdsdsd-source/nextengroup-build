...
export default function NotFound() {
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-[#02040A] px-6 py-28 text-[var(--ink)]">
      ...
      <section className="relative mx-auto flex min-h-[calc(100dvh-14rem)] max-w-4xl flex-col justify-center">
        ...
        <h1 className="max-w-3xl text-balance text-5xl font-extrabold leading-[0.98] tracking-[-0.04em] text-[var(--ink)] sm:text-7xl">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            href="/#kontakt"
            className="inline-flex items-center justify-center rounded-xl border border-[var(--line-strong)] bg-white/[0.04] px-5 py-3 text-sm font-bold text-[var(--ink)] transition duration-200 hover:bg-white/[0.08] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-300 active:scale-[0.98]"
          >
            Przejdź do kontaktu
          </Link>
        </div>
