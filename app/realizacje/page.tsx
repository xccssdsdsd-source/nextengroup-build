...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `https://getbuild.pl/api/og?title=${encodeURIComponent('Portfolio i Realizacje')}`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`https://getbuild.pl/api/og?title=${encodeURIComponent('Portfolio i Realizacje')}`],
  },
}
