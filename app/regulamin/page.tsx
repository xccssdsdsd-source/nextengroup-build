      ...
      <section className="relative bg-[#0A0E14] pt-20 pb-16 sm:pt-28 sm:pb-24">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8">
          ...
          <div className="space-y-10">
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>1. Postanowienia ogólne</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>2. Zakres usług</h2>
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>3. Warunki współpracy</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>4. Płatności</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>5. Prawa autorskie</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>6. Odpowiedzialność</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>7. Ochrona danych osobowych</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>8. Reklamacje</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>9. Zmiany regulaminu</h2>
              <p className="text-[15px] leading-[1.7] text-[#A6B2C4]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[#EAF0F7] mb-4" style={{ fontFamily: 'var(--font-syne)' }}>10. Kontakt</h2>
