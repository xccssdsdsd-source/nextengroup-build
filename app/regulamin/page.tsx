    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative bg-[var(--bg-base)] pt-20 pb-16 sm:pt-28 sm:pb-24">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8">
          <div className="mb-12">
            <span className="text-[11px] font-semibold uppercase tracking-widest text-[var(--brand)] mb-3 block">Dokumenty</span>
          ...
          <div className="space-y-10">
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>1. Postanowienia ogólne</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>2. Zakres usług</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)] mb-4">Getbuild świadczy usługi z zakresu:</p>
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>3. Warunki współpracy</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>4. Płatności</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>5. Prawa autorskie</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>6. Odpowiedzialność</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>7. Ochrona danych osobowych</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>8. Reklamacje</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>9. Zmiany regulaminu</h2>
              <p className="text-[15px] leading-[1.7] text-[var(--ink-2)]">
            ...
            <section>
              <h2 className="text-[24px] sm:text-[28px] font-extrabold tracking-[-0.02em] text-[var(--ink)] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>10. Kontakt</h2>
