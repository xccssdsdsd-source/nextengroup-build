    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative bg-[var(--bg-base)] py-12 md:py-20 px-6 md:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6 text-[var(--ink-2)] leading-[1.7]">
            <p>
              Ceny wdrożenia są podane w pakietach: Landing page agenta to około 1997 zł, Biuro z panelem ofert kosztuje 2997 zł, a pakiet dla deweloperów i biur — Deweloper i biuro — 4997 zł. Cena landinga jest orientacyjna, bo zależy od liczby sekcji; dwa pozostałe pakiety mają cenę sztywną. Pierwszą wizualizację strony wykonujemy w 24 godziny bez zobowiązań.
            </p>
          </div>
        </div>
      </section>
