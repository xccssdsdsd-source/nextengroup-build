...
const mainPaths = [
  ...
  { d: 'M -100 420 Q 300 240 600 260 Q 900 280 1300 60', color: '#888888', width: 0.4, dur: 32 },
  { d: 'M 1300 560 Q 950 400 660 360 Q 370 320 -100 170', color: '#555555', width: 0.45, dur: 30 },
]
