...
const paths = [
  { d: 'M -80 250 Q 180 150 450 120 Q 720 90 1100 50', color: '#1D4ED8', width: 0.9 },
  { d: 'M -80 310 Q 160 190 410 160 Q 680 130 1100 110', color: '#3B82F6', width: 0.5 },
  { d: 'M 1100 200 Q 750 280 450 350 Q 150 420 -80 520', color: '#60A5FA', width: 0.7 },
]
