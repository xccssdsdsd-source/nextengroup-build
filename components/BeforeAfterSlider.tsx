  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {building && (
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(rgba(76, 130, 234,0.18) 1px, transparent 1px), linear-gradient(90deg, rgba(76, 130, 234,0.18) 1px, transparent 1px)',
        ...
        <m.span
          className="pointer-events-none absolute right-3 top-3 z-30 rounded-full bg-[#4C82EA]/90 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-[#06141A] backdrop-blur-sm"
        ...
        <m.div className="pointer-events-none absolute inset-y-0 z-30" style={{ left: handleLeft, x: '-50%' }}>
          <div
            ...
            style={building ? { boxShadow: '0 0 14px 2px rgba(76, 130, 234,0.8)' } : undefined}
          />
          <button
            type="button"
            role="slider"
            ...
            onKeyDown={onKeyDown}
            className="pointer-events-auto absolute top-1/2 left-1/2 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#0D0D0D] shadow-[0_4px_14px_rgba(0,0,0,0.5)] ring-1 ring-black/10 transition-transform duration-150 hover:scale-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4C82EA]"
      ...
      <div className="flex items-center justify-center">
        <div className="inline-flex items-center rounded-full bg-[#161C28] p-1 ring-1 ring-[rgba(255,255,255,0.08)]">
          ...
          <button
            ...
            className={`rounded-full px-5 py-2 text-[12px] font-bold uppercase tracking-[0.1em] transition-[color,background-color,box-shadow,transform] duration-200 ease-out ${
              mode === 'after' ? 'bg-[#4C82EA] text-[#06141A] shadow-sm' : 'text-[#A6B2C4] hover:text-[#EAF0F7]'
            }`}
          >
            {afterLabel}
          </button>
