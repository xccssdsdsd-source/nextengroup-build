...
function LaptopScreen() {
  return (
    <svg viewBox="0 0 700 440" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', width: '100%', height: 'auto' }}>
      ...
      {/* logo */}
      <circle cx="29" cy="62" r="13" fill="rgba(76, 130, 234,0.15)" />
      <circle cx="29" cy="62" r="5" fill="rgba(76, 130, 234,0.7)" />
      <rect x="12" y="86" width="34" height="3" rx="1.5" fill="rgba(255,255,255,0.09)" />
      {/* nav items */}
      {[0,1,2,3,4].map(i => (
        <g key={i}>
          <rect x="9" y={104+i*38} width="40" height="30" rx="6" fill={i===0?'rgba(76, 130, 234,0.16)':'rgba(255,255,255,0.04)'} />
          <rect x="18" y={112+i*38} width="22" height="4" rx="2" fill={i===0?'rgba(76, 130, 234,0.7)':'rgba(255,255,255,0.14)'} />
          <rect x="18" y={119+i*38} width="16" height="3" rx="1.5" fill={i===0?'rgba(76, 130, 234,0.35)':'rgba(255,255,255,0.07)'} />
        </g>
      ))}
      {/* bottom user */}
      ...
      <circle cx="680" cy="58" r="9" fill="#4C82EA" opacity="0.85" />
      ...
      <defs>
        ...
        <radialGradient id="cg" cx="65%" cy="35%" r="55%">
          <stop offset="0%" stopColor="rgba(76, 130, 234,0.13)" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
      </defs>
      <rect x="59" y="80" width="641" height="200" fill="url(#cg)" />
      {/* hero text */}
      <rect x="80" y="102" width="90" height="8" rx="3" fill="rgba(76, 130, 234,0.25)" />
      ...
      <rect x="80" y="208" width="96" height="28" rx="7" fill="#4C82EA" />
      ...
      <rect x="412" y="108" width="118" height="66" rx="7" fill="rgba(76, 130, 234,0.09)" stroke="rgba(76, 130, 234,0.18)" strokeWidth="1" />
      <rect x="418" y="116" width="60" height="6" rx="2" fill="rgba(76, 130, 234,0.55)" />
      <rect x="418" y="126" width="90" height="4" rx="2" fill="rgba(76, 130, 234,0.22)" />
      <rect x="418" y="134" width="70" height="4" rx="2" fill="rgba(76, 130, 234,0.16)" />
      <rect x="418" y="144" width="80" height="4" rx="2" fill="rgba(76, 130, 234,0.12)" />
      <rect x="418" y="155" width="48" height="14" rx="4" fill="rgba(76, 130, 234,0.2)" />
      {/* spark */}
      <circle cx="465" cy="162" r="3" fill="#4C82EA" opacity="0.8" />
      ...
      <rect x="412" y="220" width="56" height="14" rx="4" fill="rgba(76, 130, 234,0.18)" />
    ...
    <svg viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', width: '100%', height: 'auto' }}>
      ...
      <defs>
        ...
        <radialGradient id="phg" cx="50%" cy="40%" r="60%">
          <stop offset="0%" stopColor="rgba(76, 130, 234,0.12)" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
      </defs>
      <circle cx="20" cy="46" r="11" fill="rgba(255,255,255,0.08)" />
      <circle cx="20" cy="46" r="4" fill="rgba(76, 130, 234,0.6)" />
      ...
      <rect x="16" y="86" width="70" height="7" rx="3" fill="rgba(76, 130, 234,0.25)" />
      ...
      <rect x="16" y="170" width="78" height="24" rx="7" fill="#4C82EA" />
    ...
    >
      ...
      <div style={{ position: 'relative', width: laptopW }}>
        ...
        >
          <div style={{
            ...
            boxShadow: [
              ...
              '0 40px 100px rgba(76, 130, 234,0.16)',
            ...
            <div style={{ borderRadius: '6px 6px 0 0', overflow: 'hidden', lineHeight: 0, border: '1px solid rgba(0,0,0,0.1)', borderBottom: 'none', position: 'relative' }}>
              <LaptopScreen />
              <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', background: 'linear-gradient(112deg, rgba(255,255,255,0.10) 0%, rgba(255,255,255,0.035) 24%, transparent 42%, transparent 78%, rgba(186, 206, 240,0.03) 100%)' }} />
            </div>
        ...
        >
          <div style={{
            ...
            boxShadow: [
              ...
              '0 6px 20px rgba(76, 130, 234,0.10)',
            ].join(','),
          }}>
        ...
        <div style={{
          ...
          background:'rgba(14,20,32,0.94)', border:'1px solid rgba(76, 130, 234,0.22)',
          borderRadius:'12px', padding:'9px 13px',
          backdropFilter:'blur(14px)', WebkitBackdropFilter:'blur(14px)',
          display:'flex', alignItems:'center', gap:'10px',
          boxShadow:'0 8px 28px rgba(0,0,0,0.5)', zIndex:10, whiteSpace:'nowrap',
        }}>
          <div style={{ width:'28px', height:'28px', borderRadius:'50%', flexShrink:0, background:'linear-gradient(135deg,rgba(76, 130, 234,0.18) 0%,rgba(76, 130, 234,0.05) 100%)', border:'1px solid rgba(76, 130, 234,0.28)', display:'flex', alignItems:'center', justifyContent:'center' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4C82EA" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
          </div>
          <div>
        ...
        <div style={{
          ...
          <div style={{ width:'28px', height:'28px', borderRadius:'50%', flexShrink:0, background:'linear-gradient(135deg,rgba(245,181,71,0.18) 0%,rgba(245,181,71,0.04) 100%)', border:'1px solid rgba(245,181,71,0.28)', display:'flex', alignItems:'center', justifyContent:'center' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4C82EA" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
          </div>
          <div>
