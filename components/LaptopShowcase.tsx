...
export default function LaptopShowcase({ trigger }: LaptopShowcaseProps) {
  return (
    <div className="relative mx-auto flex h-full w-full max-w-[920px] items-center justify-center">
      <motion.div
        className="pointer-events-none absolute inset-x-[8%] top-[8%] h-32 rounded-full bg-[radial-gradient(circle,rgba(0,212,255,0.32),rgba(26,111,255,0.12)_38%,transparent_72%)] blur-3xl"
        animate={{ opacity: [0.55, 0.9, 0.6], scale: [0.96, 1.08, 0.98] }}
        transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
      />

      <motion.div
        className="pointer-events-none absolute left-[10%] top-[13%] h-28 w-28 rounded-[28px] border border-white/10 bg-white/[0.05] backdrop-blur-xl"
        animate={{ y: [0, -16, 0], rotate: [-8, -2, -8] }}
        transition={{ duration: 7.2, repeat: Infinity, ease: 'easeInOut' }}
      >
        <div className="m-4 h-3 rounded-full bg-white/15" />
        <div className="mx-4 mt-5 grid grid-cols-2 gap-3">
          <div className="h-10 rounded-2xl bg-cyan-300/40 shadow-[0_0_40px_rgba(0,212,255,0.25)]" />
      ...
      <motion.div
        className="pointer-events-none absolute bottom-[16%] right-[6%] h-36 w-32 rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.03))] backdrop-blur-xl"
        animate={{ y: [0, 14, 0], rotate: [10, 3, 10] }}
      ...
      >
        <motion.div
          className="absolute inset-x-[8%] bottom-[-8%] h-20 rounded-full bg-[radial-gradient(circle,rgba(26,111,255,0.42),rgba(0,212,255,0.16)_45%,transparent_72%)] blur-2xl"
          animate={{ scaleX: [0.92, 1.04, 0.95], opacity: [0.35, 0.65, 0.42] }}
          transition={{ duration: 5.2, repeat: Infinity, ease: 'easeInOut' }}
        />

        <motion.div
          className="relative laptop-float"
          animate={{ rotateY: [-8, -4, -8], rotateX: [10, 7, 10], y: [0, -10, 0] }}
        ...
        >
          <motion.div
            ...
            initial={{ rotateX: 80 }}
            animate={{ rotateX: 0 }}
            transition={{ duration: 1.35, delay: 0.12, ease }}
          ...
          >
            <div className="relative h-full rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.03))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                    ...
                    <div className="grid grid-cols-[1.1fr_0.72fr] gap-3">
                      <div className="rounded-[20px] border border-white/6 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))] p-3">
                        ...
                        <div className="mt-4 grid grid-cols-3 gap-2">
                          <motion.div
                            className="h-20 rounded-[20px] bg-[linear-gradient(180deg,rgba(0,212,255,0.5),rgba(26,111,255,0.14))]"
                            animate={{ y: [0, -8, 0] }}
                    ...
                    <div className="grid grid-cols-[1.05fr_0.95fr] gap-3">
                      ...
                      <div className="rounded-[20px] border border-white/6 bg-white/[0.045] p-3">
                        ...
                        <div className="mt-4 grid gap-2">
                          <motion.div
                            className="h-11 rounded-[18px] bg-white/9"
                            animate={{ x: [0, 8, 0] }}
                            transition={{ duration: 4.2, repeat: Infinity, ease: 'easeInOut' }}
                          />
                          <motion.div
                            className="h-11 rounded-[18px] bg-[linear-gradient(90deg,rgba(0,212,255,0.28),rgba(26,111,255,0.16))]"
                            animate={{ x: [0, -10, 0] }}
              ...
              <motion.div
                className="absolute inset-y-[12%] right-[24%] w-[22%] rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.2),rgba(255,255,255,0.02))] blur-2xl"
                animate={{ opacity: [0.15, 0.3, 0.18], x: [0, 12, 0] }}
          ...
          <motion.div
            className="relative mx-auto -mt-3 h-[26px] w-[108%] rounded-b-[32px] rounded-t-[14px] border border-white/10 bg-[linear-gradient(180deg,#b8c4d8_0%,#7f8ea5_24%,#384658_56%,#172030_100%)] shadow-[0_28px_60px_rgba(0,0,0,0.38)]"
            initial={{ scaleX: 0.92, opacity: 0.8 }}
            animate={{ scaleX: [1, 1.015, 1], opacity: [0.92, 1, 0.95] }}
            transition={{ duration: 5.2, repeat: Infinity, ease: 'easeInOut' }}
