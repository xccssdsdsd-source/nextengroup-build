...
const projects: Project[] = [
  {
    ...
    owner: { name: 'Patryk Zacharek', role: 'Właściciel, PM Apartments', photo: '/owner-pm-apartments.png' },
  },
  {
    kind: 'image',
    ...
    owner: { name: 'Magdalena Sioła', role: 'Właścicielka, MS Design Studio', photo: '/owner-msdesignstudio.png' },
  },
  {
    kind: 'slider',
    name: 'Dorimari',
    ...
    owner: { name: 'Dori', role: 'Właścicielka, Dorimari', photo: '/owner-dorimari.png' },
  },
]
