              ...
              <li key={step.num} className="process-card premium-card overview-card group">
                ...
                <div className="process-card__header">
                  ...
                  <div className="process-card__heading">
                    ...
                    <h3 className="process-card__title mt-1 text-[1.2rem] font-bold tracking-[-0.03em] leading-tight text-[#EAF0F7]" style={{ fontFamily: 'var(--font-heading)' }}>
                      {step.title}
                    </h3>
                  </div>
                </div>

                <p className="process-card__description mt-5 text-[14px] leading-[1.7] text-[#A6B2C4] transition-colors duration-300 group-hover:text-[#C0CCDC]">{step.desc}</p>
