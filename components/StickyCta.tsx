    ...
    <AnimatePresence>
      {visible && !contactInView && (
        <m.a
          ...
          whileTap={{ scale: 0.97 }}
          className="fixed bottom-6 right-6 z-50 hidden min-h-12 items-center gap-2.5 rounded-xl bg-[#4C82EA] px-5 py-3 text-[13px] font-bold text-[#06141A] shadow-[inset_0_1px_0_rgba(255,255,255,0.28),_0_14px_34px_-20px_rgba(76, 130, 234,0.9),_0_2px_8px_rgba(0,0,0,0.45)] transition-[background,box-shadow,transform] duration-200 hover:bg-[#9DBBEC] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.34),_0_18px_42px_-22px_rgba(76, 130, 234,1),_0_3px_10px_rgba(0,0,0,0.5)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4C82EA] focus-visible:ring-offset-2 sm:inline-flex"
        >
