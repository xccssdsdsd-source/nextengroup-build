      ...
      >
        <defs>
          <linearGradient id="l1" x1="-250" y1="820" x2="1440" y2="0" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="22%" stopColor="#22D3EE" stopOpacity="0.22" />
            <stop offset="78%" stopColor="#5EEAFF" stopOpacity="0.22" />
          ...
          <linearGradient id="l2" x1="-250" y1="80" x2="1440" y2="900" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#22D3EE" stopOpacity="0" />
            <stop offset="22%" stopColor="#22D3EE" stopOpacity="0.16" />
            <stop offset="78%" stopColor="#5EEAFF" stopOpacity="0.16" />
            <stop offset="100%" stopColor="#5EEAFF" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="l3" x1="820" y1="-100" x2="1100" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="28%" stopColor="#F5B547" stopOpacity="0.12" />
            <stop offset="72%" stopColor="#F5B547" stopOpacity="0.12" />
          ...
          <linearGradient id="frameStroke" x1="0" y1="0" x2="1440" y2="900" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#5EEAFF" stopOpacity="0.16" />
            <stop offset="50%" stopColor="#FFFFFF" stopOpacity="0.06" />
            <stop offset="100%" stopColor="#5EEAFF" stopOpacity="0.16" />
          </linearGradient>
          ...
          <radialGradient id="glowBR" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(1320 840) scale(560)">
            <stop offset="0%" stopColor="#5EEAFF" stopOpacity="0.06" />
            <stop offset="100%" stopColor="#5EEAFF" stopOpacity="0" />
          </radialGradient>
          <style>{`
