        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {items.map((item, i) => (
            <m.a
              ...
              whileHover={{ y: -4 }}
              className="group relative overflow-hidden rounded-xl border border-[var(--border)] bg-[#161C28] transition-[box-shadow,transform] duration-200 hover:shadow-[0_4px_16px_rgba(76, 130, 234,0.18),0_8px_28px_rgba(76, 130, 234,0.12)]"
            >
              ...
              <div className="flex items-center justify-between px-3 py-2.5">
                ...
                <ArrowUpRight size={14} className="text-[#7C879B] transition-[color,transform] duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[#4C82EA]" />
              </div>
            </m.a>
          ))}
        </div>
