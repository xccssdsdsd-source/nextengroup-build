...
await mobPage.screenshot({ path: 'screenshots/mob-final.png', fullPage: false })
await mobPage.screenshot({ path: 'screenshots/mob-full-final.png', fullPage: true })
...
await desPage.screenshot({ path: 'screenshots/desk-final.png', fullPage: false })
